...
import { getInquiries, getSellers, getDashboardStats, downloadInquiryPDF, deleteInquiry } from '@/app/lib/api';
...
export default function AdminDashboard() {
  ...
  async function fetchData() {
    try {
      setLoading(true);
      const [inqRes, sellerRes, statRes] = await Promise.all([
    ...
    <div className="space-y-6 pb-12 relative">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-gray-200 flex justify-between items-center bg-gray-50">
          ...
          <Link href="/admin/inquiries" className="text-sm font-medium text-orange-600 hover:text-orange-800 bg-orange-50 px-3 py-1.5 rounded-md">View All Inquiries →</Link>
        </div>
                  ...
                  <tr key={inq.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-3">
                        <Link href={`/admin/inquiries/${inq.id}`} className="text-orange-600 hover:text-orange-800 font-semibold">View</Link>
